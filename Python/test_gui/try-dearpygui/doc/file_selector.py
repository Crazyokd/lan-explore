# The file dialog item can be used to select a single file, multiple files, or a directory. 
# When the user clicks the Ok button, the dialog’s callback is ran.

# Information is passed through the app_data argument such as: 
# * file path * file name * current path * current filter (the file type filter)
