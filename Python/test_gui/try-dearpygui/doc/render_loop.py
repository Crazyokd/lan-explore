...
# Drawing the items is how the DPG appears to update items. 
# DPG does this at the rate of your monitor refresh when set_viewport_vsync is set True. If vsync is set False the render loop will run as fast possible.
